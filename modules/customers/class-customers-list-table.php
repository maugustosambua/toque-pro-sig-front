<?php // modules/customers/class-customers-list-table.php
...
class TPS_Customers_List_Table extends WP_List_Table {
    ...
    protected function column_actions( $item ) {
        ...
        $delete_url = wp_nonce_url(
            admin_url( 'admin-post.php?action=tps_delete_customer&customer_id=' . (int) $item->id ),
            'tps_delete_customer'
        );

        $export_url = wp_nonce_url(
            admin_url( 'admin-post.php?action=tps_export_customer&customer_id=' . (int) $item->id ),
            'tps_export_customer'
        );
